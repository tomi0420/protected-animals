class NewAnimal
  ...
  attr_accessor :name, :age, :birth_date, :info, :personality, :animal_category_id, :size_id, :kind, :sex_id, :prefecture_id, :user_id
  ...
  def save
   ...
   Tags.create(animal_category_id: animal_category_id, size_id: size_id, kind: kind, sex_id: sex_id, prefecture_id: prefecture_id )
  end
